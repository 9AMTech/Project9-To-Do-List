...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "captureDOM": () => (/* binding */ captureDOM)
/* harmony export */ });
/* harmony import */ var _js_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/functions.js */ "./src/js/functions.js");
/* harmony import */ var _js_generate_page_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/generate-page.js */ "./src/js/generate-page.js");
...
const initialRender = (function () {
    ...
    _js_generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.generateBoard('loop');
    _js_generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.createToolbar('initial');
    if (_js_functions_js__WEBPACK_IMPORTED_MODULE_0__.manageList.bulletinBoard.length === 0) {
        _js_generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.createBoardNotification();
    }
    return {
    }
})();
...
const bulletinBoardLogic = (function () {
    ...
    captureDOM.formSection.addEventListener('click', function () {
        _js_functions_js__WEBPACK_IMPORTED_MODULE_0__.toolbarFunctions.toggleForm('add', captureDOM.formSection);
    });

    // This will remove the form when clicking outside the form
    captureDOM.form.addEventListener('click', function (event) {
        _js_functions_js__WEBPACK_IMPORTED_MODULE_0__.toolbarFunctions.toggleForm('remove', captureDOM.formSection);
    ...
    captureDOM.form.addEventListener("submit", function (event) {
        if (_js_functions_js__WEBPACK_IMPORTED_MODULE_0__.manageList.bulletinBoard.length === 0) {
            _js_generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.removeBoardNotification();
        }
        _js_functions_js__WEBPACK_IMPORTED_MODULE_0__.manageList.createList(event);
        _js_generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.generateBoard('add');

    });

    _js_functions_js__WEBPACK_IMPORTED_MODULE_0__.pageFunctions.formTextLimit(captureDOM.formTitle, 20);
    _js_functions_js__WEBPACK_IMPORTED_MODULE_0__.pageFunctions.formTextLimit(captureDOM.formDescription, 35);
...
/* harmony export */   "toolbarFunctions": () => (/* binding */ toolbarFunctions),
/* harmony export */   "pageFunctions": () => (/* binding */ pageFunctions),
/* harmony export */   "renderDOM": () => (/* binding */ renderDOM)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/format/index.js");
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ "./src/index.js");
/* harmony import */ var _generate_page_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./generate-page.js */ "./src/js/generate-page.js");
...
const manageList = (function () {
    ...
    const testData = {
        ...
        creationDate: (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'MM/dd/yyyy'),
    ...
    const createList = (event) => {
        ...
        // Puling form data
        let fd = new FormData(_index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.form);
        ...
        newList.creationDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'M/dd/yyyy');
        ...
        _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.form.reset();
...
const pageFunctions = (function () {
    ...
    const formatDate = (todoDate) => {
        ...
        if (currentYear != parsedDate.getFullYear()) {
            let convertedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dtDateOnly, 'M/dd/yyyy');
            return convertedDate;
        }
        else {
            let convertedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(dtDateOnly, 'M/dd');
            return convertedDate;
        }
    };
    ...
    return {
        ...
        formTextLimit: formTextLimit,
        preventEnter: preventEnter,
        optionValueGrabber: optionValueGrabber,
...
const renderDOM = (function () {
    ...
    const list = (index) => {
        ...
        pageFunctions.removeChildren(_index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.content);

        // Manipulating Elements
        _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.content.classList.toggle('list');
        ...
        dueDateEditButton.addEventListener('change', function () {
            ...
            manageList.bulletinBoard[index].dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(Date.parse(dueDateEditButton.value), 'Pp');
            dueDate.textContent = `Due by ${pageFunctions.formatDate(manageList.bulletinBoard[index].dueDate)}`;
            localStorage.setItem('bulletinBoard' , JSON.stringify(manageList.bulletinBoard));
        });
        ...
        backButton.addEventListener('click', function () {
            ...
            // Filling New Data
            _generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.createToolbar('home');
            _generate_page_js__WEBPACK_IMPORTED_MODULE_1__.generateBulletinBoard.generateBoard('loop');
        });
        ...
        _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.content.append(infoSection, listWrapper, addTask);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "generateBulletinBoard": () => (/* binding */ generateBulletinBoard)
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../index.js */ "./src/index.js");
...
const generateBulletinBoard = (function () {
    ...
    const createToolbar = (configuration) => {
        if (configuration === 'initial') {
            ...
            addListButton.addEventListener('click', function () {
                _functions_js__WEBPACK_IMPORTED_MODULE_1__.toolbarFunctions.toggleForm('toggle', _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.formSection);
            });


            // Appending Elements
            _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.toolbarContainer.prepend(toolbar);
    ...
    const createBoardNotification = () => {
        ...
        _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.content.appendChild(notificationTextWrapper);
    ...
    const generateBoard = (configuration) => {
        ...
        const bulletinBoardSetup = (index) => {
            ...
            // List Section
            list.dataset.id = _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[index].id;
            ...
            title.textContent = _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[index].title;

            // List 
            description.classList.add('list-description');
            description.textContent = _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[index].description;

            // List Due Date
            dueDate.classList.add('list-due-date');
            dueDate.textContent = `Due by ${_functions_js__WEBPACK_IMPORTED_MODULE_1__.pageFunctions.formatDate(_functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[index].dueDate)}`;

            // List Delete Button
            deleteButton.dataset.id = _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[index].id;
            ...
            list.addEventListener('click', function () {
                ...
                let index = 0;
                for (let f = 0; f < _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard.length; f++) {
                    if (_functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[f].id == list.dataset.id) {
                        index = f;
                    }
                }
                ...
                _functions_js__WEBPACK_IMPORTED_MODULE_1__.renderDOM.list(index);
            });

            // On click event listener to the deleteButton
            deleteButton.addEventListener('click', function (event) {
                event.stopPropagation();
                for (let i = 0; i < _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard.length; i++) {
                    // we are doing a loop to find the list in manageList.bulletinBoard
                    // with the corresponding id to the trashcan SVG
                    if (deleteButton.dataset.id == _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard[i].id) {
                        _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard.splice(i, 1);
                        let list = document.querySelector(`[data-id="${deleteButton.dataset.id}"]`)
                        _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.content.removeChild(list);
                    }
                }
                localStorage.setItem('bulletinBoard' , JSON.stringify(_functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard));
                if (_functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard.length === 0) {
            ...
            // Appending Elements
            _index_js__WEBPACK_IMPORTED_MODULE_0__.captureDOM.content.appendChild(list);
        ...
        if (configuration === 'add') {
            let lastList = _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.bulletinBoard.length - 1;
            bulletinBoardSetup(lastList);
            _functions_js__WEBPACK_IMPORTED_MODULE_1__.manageList.idCounter++;
        }
    }
    ...
    return {
        ...
        createBoardNotification: createBoardNotification,
        removeBoardNotification: removeBoardNotification,
    }
})();
